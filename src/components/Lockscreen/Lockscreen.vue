            ...
            <div class="login-box">
                ...
                <div class="flex justify-around w-full mt-1">
                    <n-space justify="space-between">
                        <n-button text type="info" @click="showLogin = false">返回</n-button>
                        <n-button text type="warning" @click="goLogin">重新登录</n-button>
                        <n-button text type="success" @click="onLogin">进入系统</n-button>
                    </n-space>
                </div>
            </div>
        </template>
...
<script lang="ts">
    ...
    import { UserInfoType } from '@/api/system/user';
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            // const username = userInfo.user_name || ''; // TODP
